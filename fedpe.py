...
from dataloader import get_task_dataset_fedpe, TrainDataset_fedpe, TestDataset_fedpe
...
class KGERunner:
    def __init__(self, args, data):
        ...
        # load the data
        train_dataset, valid_dataset, test_dataset, nrelation, nentity = get_task_dataset_fedpe(data, args)
        ...
        self.train_dataloader = DataLoader(
            ...
            shuffle=True,
            collate_fn=TrainDataset_fedpe.collate_fn
        )

        self.valid_dataloader = DataLoader(
            valid_dataset,
            batch_size=args.test_batch_size,
            collate_fn=TestDataset_fedpe.collate_fn
        )
    ...
    def train(self):
        ...
        for epoch in range(self.args.max_epoch):
            ...
            if epoch > 0 and epoch % self.args.check_per_epoch == 0:
