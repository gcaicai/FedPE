...
See GitHub for more details:
    https://github.com/adriancaruana/py_wlgk
...
def _compute_colour_counts(G: nx.Graph, num_iterations: int) -> Dict[int, int]:
    ...
    for _ in range(num_iterations):
        ...
        # print('node_colours = new_node_colours:', node_colours)
        # Update the colour counts with the new node colours
        colour_counts = _update_colour_counts(colour_counts, node_colours)
        # print('colour_counts = _update_colour_counts:', colour_counts)
...
def wlgk(G1: nx.Graph, G2: nx.Graph, num_iterations: int = 30) -> float:
